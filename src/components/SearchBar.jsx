...
<nav
  className="relative flex w-full flex-wrap items-center justify-between bg-[#838a5c] py-2 text-neutral-500 shadow-lg hover:text-neutral-700 focus:text-neutral-700  lg:py-4">
  <div className="flex w-full flex-wrap items-center justify-between px-3">
    <button
      ...
      <form className="ml-5 flex w-[30%] items-center justify-between" onSubmit={handleSubmit}>
      <input
        type="search"
